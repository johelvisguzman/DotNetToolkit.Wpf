...
using DotNetToolkit.Wpf.Common;
using DotNetToolkit.Wpf.ComponentModel;

namespace DotNetToolkit.Wpf.Data
{
    /// <summary>
        ...
        private void RefreshOverride()
        {
            ...
            if (UsesLocalArray)
            {
                try
                {
                    ...
                    _internalList = (IList)PrepareLocalArray(_sourceCollection);
